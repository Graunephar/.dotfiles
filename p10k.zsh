# Generated by Powerlevel10k configuration wizard on 2022-12-17 at 01:54 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                     # git status
    firebase                # Firebase project custom
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION='😨 ▶ ' # ✖😡😨️😳🙀️
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION='😸️ ️▶ ' # ✦ ➔ ➜ ➤ ▶ 😺️😊 😹️
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%196F'  # RED foreground
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=201
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=201
  ...
  #Inspired by this https://github.com/soheilnikbin/firebase-prompt-powerlevel9k
  # but customized with firebase plugin plugin
  function prompt_firebase() {
    local fb_project=$(firebase_project) # Load firebase from this plugin https://github.com/Seqi/firebase-zsh
  ...
  typeset -g FIREBASE_ZSH_STYLE='plain'
  typeset -g FIREBASE_ZSH_TEXT='bold'

  #Set foreground color in plugin since it depends on content in firebase.plugin.zsh
  #typeset -g POWERLEVEL9K_FIREBASE_FOREGROUND='146'
  typeset -g POWERLEVEL9K_FIREBASE_BACKGROUND='238'
